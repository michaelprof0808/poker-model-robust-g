...
export POKER44_MODEL_FACTORY=${POKER44_MODEL_FACTORY:-poker44_champion_v6.model:create_model}
export POKER44_MODEL_VERSION=${POKER44_MODEL_VERSION:-round7-primary-v6-robust-2}
unset POKER44_MODEL_PATH
unset POKER44_CHAMPION_ALLOW_UNPROMOTED
